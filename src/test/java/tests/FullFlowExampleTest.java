...
public class FullFlowExampleTest {
    ...
    public void multipleRequestsToCompleteAFullFlowTest() throws IOException {
        ...
        Response deleteUser = given().log().all().pathParam("username", userName).when().delete("http://petstore.swagger.io/v2/user/{username}");
        System.out.println("The user details are: " + deleteUser.asString());
